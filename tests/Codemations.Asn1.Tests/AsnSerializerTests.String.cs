...
namespace Codemations.Asn1.Tests
{
    internal partial class AsnSerializerTests
    {
        private static IEnumerable<TestCaseData> GetStringTestCases()
        {
            ...
            yield return new TestCaseData((IA5String)@"Arek", new byte[] { 0x16, 0x04, 0x41, 0x72, 0x65, 0x6B });
            yield return new TestCaseData((IA5String?)@"Arek", new byte[] { 0x16, 0x04, 0x41, 0x72, 0x65, 0x6B });
            yield return new TestCaseData((VisibleString)@"Arek", new byte[] { 0x1A, 0x04, 0x41, 0x72, 0x65, 0x6B });
            yield return new TestCaseData((VisibleString?)@"Arek", new byte[] { 0x1A, 0x04, 0x41, 0x72, 0x65, 0x6B });
            yield return new TestCaseData((PrintableString)@"Arek", new byte[] { 0x13, 0x04, 0x41, 0x72, 0x65, 0x6B });
            yield return new TestCaseData((PrintableString?)@"Arek", new byte[] { 0x13, 0x04, 0x41, 0x72, 0x65, 0x6B });
            yield return new TestCaseData((T61String)@"Arek", new byte[] { 0x14, 0x04, 0x41, 0x72, 0x65, 0x6B });
            yield return new TestCaseData((T61String?)@"Arek", new byte[] { 0x14, 0x04, 0x41, 0x72, 0x65, 0x6B });
            yield return new TestCaseData((BmpString)@"Arek", new byte[] { 0x1E, 0x08, 0x00, 0x41, 0x00, 0x72, 0x00, 0x65, 0x00, 0x6B });
            yield return new TestCaseData((BmpString?)@"Arek", new byte[] { 0x1E, 0x08, 0x00, 0x41, 0x00, 0x72, 0x00, 0x65, 0x00, 0x6B });
            yield return new TestCaseData((NumericString)@"1234", new byte[] { 0x12, 0x04, 0x31, 0x32, 0x33, 0x34 });
            yield return new TestCaseData((NumericString?)@"1234", new byte[] { 0x12, 0x04, 0x31, 0x32, 0x33, 0x34 });
        }
