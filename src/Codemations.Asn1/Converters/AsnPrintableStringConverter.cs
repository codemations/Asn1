...
internal class AsnPrintableStringConverter : AsnConverter<PrintableString>
{
    ...
    public override void Write(AsnWriter writer, Asn1Tag? tag, PrintableString value, AsnSerializer serializer)
    {
