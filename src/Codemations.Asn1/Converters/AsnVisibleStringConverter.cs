...
internal class AsnVisibleStringConverter : AsnConverter<VisibleString>
{
    ...
    public override void Write(AsnWriter writer, Asn1Tag? tag, VisibleString value, AsnSerializer serializer)
    {
