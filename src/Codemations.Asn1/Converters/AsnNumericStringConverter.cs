...
internal class AsnNumericStringConverter : AsnConverter<NumericString>
{
    ...
    public override void Write(AsnWriter writer, Asn1Tag? tag, NumericString value, AsnSerializer serializer)
    {
