...
internal class AsnConvertersList : List<AsnConverter>
{
    ...
    public static AsnConvertersList CreateDefault()
    {
        return new AsnConvertersList()
        {
            ...
            new AsnUtf8StringConverter(),
            new AsnNumericStringConverter(),
            new AsnPrintableStringConverter(),
            new AsnVisibleStringConverter(),
            new AsnBmpStringConverter(),
            new AsnT61StringConverter(),
            new AsnIA5StringConverter(),
